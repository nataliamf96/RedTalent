...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/user/index").hasAuthority("USER")
                ...
                .antMatchers("/project/project").permitAll()
                .antMatchers("/directivo/dashboardDirectivo").hasAuthority("DIRECTIVO")
                .antMatchers("/project/createProject").hasAuthority("USER")
                .antMatchers("/admin/area/**").hasAuthority("ADMIN")
                .antMatchers("/admin/department/**").hasAuthority("ADMIN")
                .antMatchers("/admin/grade/**").hasAuthority("ADMIN")
                .antMatchers("/category/**").hasAuthority("ADMIN")
                .antMatchers("/admin/blog/**").hasAuthority("ADMIN")
                .antMatchers("/admin/**").hasAuthority("ADMIN")
                .antMatchers("/admin/deleteProject").hasAuthority("ADMIN")
                .antMatchers("/admin/forum/**").hasAuthority("ADMIN")
